...
| 🌙 解梦输出深化 | 2026-08-20 | EP-dream-05：用户反馈上线后输出"AI味重、不够详实"——beat②从空泛的"心理映照"改成方法论化的投射式提问（挑具体意象、区分文化通识联想与个人贴身联想，不重开符号词典）；文风反例先写字面句式被 priming 反噬（读样 16 条 10+ 中招）→改抽象措辞+频率上限（全篇至多一处否定-肯定对照），第三轮读样收敛到偶发自然用法验收通过；篇幅 8句/300字/200词→12句/500字/320词，maxTokens 700→1200 防截断；checkVoice 的 dreamMode 长度档与常规对话 allowLong 拆开独立（互不影响，回归实证）。llm252 绿，关键改动变异实证 + 三轮 probe:dream 人工读样验收 |
