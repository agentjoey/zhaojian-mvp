...
| 🎨 TG 原生 UI 地基 | 2026-06-29 | EP-tg-ui 子项目1：主题桥(跟随 TG 明/暗，深色水墨)+chrome(Back/Main button/haptics/viewport/TG 隐藏 web 导航)+原生组件(Section/Group/Cell/Bubble)+灵面板示范。非 TG web 零变化。本命之灵真形象(5 五行渲染图)上线 + LLM 额度关闭(TG_QUOTA_DISABLED)。后续各界面逐个原生重排。 |
